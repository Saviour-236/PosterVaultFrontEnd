...
function cart() {
    ...
    return (
        ...
        <>
           ...
           <button className=' flex items-center relative p-1'
            onClick={()=>(handleClickOnCart())}
            >
                <svg xmlns="http://www.w3.org/2000/svg" className='h-[1.5rem] ' fill='#c9cbccee' id="cart" x="0" y="0" version="1." viewBox="0 0 52 52">
                ...
                {totalInCart > 0 &&
                    <span className="inline-flex items-center justify-center w-4 h-4 p-[0.6rem] ms-2 text-[0.8rem] font-semibold text-[#080a2e] bg-[#26ee309f] rounded-full absolute top-0 right-[-0.4rem] 
