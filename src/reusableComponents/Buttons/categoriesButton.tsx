...
function categoriesButton() {
    ...
    return (
        <>
            ...
            {show && <div className={` fixed z-[54] top-[5.3rem] justify-center w-fit flex flex-wrap  bg-[#ffffff] overflow-hidden rounded-xl shadow-lg items-center   border left-3 right-3 space-x-2 space-y-3  px-[0.5rem] py-3 transition-[height] duration-500 ease-in
