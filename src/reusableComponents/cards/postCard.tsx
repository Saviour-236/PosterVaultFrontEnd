    ...
    return (
        <>
            ...
            >
                ...
                <img src={post.imageUrl} alt={post.alt} className={`${!isLoaded ? "opacity-0 h-0" : "min-h-[10rem] min-[6] max-h-[36rem] borderhover:cursor-pointer opacity-100 max-w-[19.5rem] rounded-md"}  transition-opacity duration-1000 ease-linear`}
