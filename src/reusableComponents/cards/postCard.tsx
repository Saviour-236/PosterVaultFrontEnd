...
const PostCards: React.FC<Props> = ({ post }) => {
    ...
    return (
        <>
            ...
            <div className="h-fit w-fit mt-3 overflow-hidden relative"
                onMouseEnter={handleCardMouseEnter}
                onMouseLeave={handleCardMouseLeave}
            >
                <img src={post.imageUrl} alt={post.alt} className="min-h-[10rem] min-[6] max-h-[36rem] borderhover:cursor-pointer max-w-[19.5rem] rounded-md "
                    onLoad={handleOnLoad}
                />
                {/* loading skeleton */}
                {isLoading && <div role="status" className="rounded-lg  min-h-[10rem] min-w-[10rem]  bg-[#5f6a6d31] flex items-center justify-center ">
