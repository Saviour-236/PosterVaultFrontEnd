...
const PostCards: React.FC<Props> = ({ post }) => {
    ...
    const optimizedImageUrl = post.imageUrl.replace("upload/", "upload/w_500,h_500,c_limit/");
    ...
    return (
        <>
            ...
            <div className="h-fit w-fit sm:m-1  overflow-hidden relative"
            ...
            >
                ...
                <img src={optimizedImageUrl} alt={post.alt} className={`${!isLoaded ? "opacity-0 h-0" : "min-h-[10rem] min-[6] max-h-[36rem] borderhover:cursor-pointer opacity-100 max-w-[19.5rem] rounded-md"}  transition-opacity duration-1000 ease-linear`}
                    onLoad={handleOnLoad}
                />
                {/* like button */}
                {
